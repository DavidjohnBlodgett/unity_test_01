...
public class SceneObjectReference
{
    ...
    [SerializeField]
    private SerializedType m_SerializedComponentType;
    [SerializeField]
    ...
    public void Update(UnityEngine.Object newObject)
    {
        ...
        else if (newObject is GameObject)
        {
            ...
            if (PrefabUtility.GetPrefabObject(go) != null && PrefabUtility.GetPrefabParent(go) == null)
            {
                m_Prefab = go;
                SaveProperties();
                return;
